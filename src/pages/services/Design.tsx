...
import { ArrowRight, Palette, Monitor, Smartphone, Layers, Sparkles, CheckCircle } from "lucide-react";

const deliverables = [
  "Brand identity and visual design systems",
  "Conversion-optimized website design",
  "Product UI/UX design and prototypes",
  "Design system and component libraries",
  "Motion design and micro-interactions",
];

const process = [
  { step: "01", title: "Research", description: "User research, competitor analysis, and requirements gathering." },
  { step: "02", title: "Wireframes", description: "Information architecture and low-fidelity wireframes." },
  { step: "03", title: "Design", description: "High-fidelity mockups with brand-aligned visual design." },
  { step: "04", title: "Handoff", description: "Developer-ready specs, assets, and design system documentation." },
];

const pricing = [
  { model: "Website Design", description: "Complete website redesign", range: "$15K - $50K" },
  { model: "Product Design", description: "Full product UI/UX", range: "$25K - $100K" },
  { model: "Design Retainer", description: "Ongoing design support", range: "$5K - $15K/mo" },
];
    ...
    <Layout>
        ...
        <div className="container-custom relative z-10">
          <AnimatedSection className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              Conversion-focused design that transforms visitors into customers. 
              We create beautiful experiences that drive measurable business results.
            </p>
          </AnimatedSection>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <AnimatedSection direction="right">
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: <Monitor className="w-6 h-6" />, label: "Web Design" },
                  { icon: <Smartphone className="w-6 h-6" />, label: "Mobile-First" },
                  { icon: <Layers className="w-6 h-6" />, label: "Design Systems" },
                  { icon: <Sparkles className="w-6 h-6" />, label: "Motion Design" },
                ].map((item) => (
      ...
      <section className="py-20 lg:py-32 bg-card/50 border-t border-border">
        <div className="container-custom text-center">
          <AnimatedSection>
            <h2 className="font-display text-3xl lg:text-5xl font-bold text-foreground mb-4">Ready to Transform Your Design?</h2>
            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-8">Let's create experiences that convert.</p>
